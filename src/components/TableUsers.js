...
const TableUsers = (props) => {
    ...
    const handleEditUserFromModal = (user ) => {
        ...
        cloneListUsers[index].company = user.company;
        cloneListUsers[index].status = user.status;
        cloneListUsers[index].phone = user.phone;
        cloneListUsers[index].date = user.date;
        cloneListUsers[index].email = user.email;
        cloneListUsers[index].website = user.website;
        cloneListUsers[index].gender = user.gender;
        cloneListUsers[index].language = user.language;
    ...
    return (<>
        <div className='my-3 add-new d-sm-flex'>
          ...
          <div className='group-btns mt-sm-0 mt-2'>
            ...
            ><i className="fa-solid fa-file-arrow-down"></i> Exprot</CSVLink>
                        ...
                        <tr key={`users-${index}`}>
                            ...
                            <td>
                                <button className='btn btn-warning mx-3'
                                    ...
                                    <i className="fa-solid fa-gear"></i> Edit</button>
                                <button 
